...
//https://github.com/DDihanov/AndroidCustomViews/blob/master/app/src/main/java/bg/dihanov/customviewexamples/MainActivity.kt

val Number.px get() = TypedValue.applyDimension(
...
@JvmOverloads constructor(
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        chartHeight = (height - WEEK_PADDING).toInt()
        chartWidth = width
        scaleSpaceToLeaveForGraduations = ((width - 2 * GRADUATIONS_SIDE_PADDING) / markers.size).toInt()
        ...
        calcAndInvalidate()
        setMeasuredDimension(chartWidth, (height + WEEK_PADDING).toInt())
    }
